...
public class CardFragment extends Fragment implements View.OnClickListener,SynthesizerListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.wrong_fragment,container,false);
        return mRootView;
    }
